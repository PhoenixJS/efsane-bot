...
.addField(`<a:kalkan: __Spam Koruması__`,` \`${prefix}spam\` Spam Korumasını Aktif Eder.`,true)
.addField(` __Self Koruma__`,` \`${prefix}self-koruma\` Self Botları Susturur.`,true)
.addField(` __Bot Koruması__`,` \`${prefix}anti-raid\` Bot Korumasını Aktif Eder.`,true)
