...
.addField(`<a:kalkan:835661236849999922> __Ban Koruması__`,` \`${prefix}ban-koruma\` Ban Korumasını Aktif Eder.`,true)
.addField(`<a:kalkan:835661236849999922> __Spam Koruması__`,` \`${prefix}spam\` Spam Korumasını Aktif Eder.`,true)
.addField(`<a:kalkan:835661236849999922> __Self Koruma__`,` \`${prefix}self-koruma\` Self Botları Susturur.`,true)
.addField(`<a:kalkan:835661236849999922> __Bot Koruması__`,` \`${prefix}anti-raid\` Bot Korumasını Aktif Eder.`,true)
