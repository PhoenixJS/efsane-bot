...
.addField(`<a:kalkan:835661236849999922> __Seviye Ayarlar__`,` \`${prefix}seviye-ayarlar\` Seviye Ayarlarını Gösterir.`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Log__`,` \`${prefix}seviye-log-ayarla <#kanal>\` Seviye Atlayınca Mesaj Gidecek Kanal.`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Rol__`,` \`${prefix}seviye-rol\` İstenilen Seviyeye Gelince Verilecek Rol`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Sıfırla__`,` \`${prefix}seviye-sıfırla\`  Seviye Sistemini Sıfırlarsınız.`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Sınır__`,` \`${prefix}seviye-sınır\` Maksimum Kazanılanabilecek Seviyeyi Belirler.`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye XP__`,` \`${prefix}seviye-xp\`  Bir Mesaj Başına Verilecek Xp yi ayarlar.`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Top5__`,` \`${prefix}seviye-top\` Sunucuda ki En yüksek 5 Kişiyi Gösterir`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Rolleri__`,` \`${prefix}seviyerolleri\` Hangi Seviye de Rol Verilecek Onu Gösterir.`,true)
.addField(`<a:kalkan:835661236849999922> __Seviye Bilgi__`,` \`${prefix}seviyebilgi\` Seviyenizi Gösterir.`,true)
